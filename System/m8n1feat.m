function [feat] = m8n1feat(eegraw)
%   Band power percentage of beta and alpha 14 channel EEG data
%   Detailed explanation goes here
    ...
    %Feature EXTRACTION
     for ch_itr = channels
        ...
        totalpow = bandpower(eegfilt(:,ch_itr),128,[7 32]);
        f1(fv_itr) = (betapow/totalpow)*100;
        f2(fv_itr) = (alphapow/totalpow)*100;
    end
    %until here
